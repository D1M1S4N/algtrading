...
def run(dinero_inicial, zona_horaria_operable, name, porcentaje_retiro, porcentaje_umbral_ganancias, tamanyo_break_even, min_spread_trigger, max_spread_trigger, 
    ...
    verbose = True
    lista_pares = ['EURUSD', 'GBPUSD', 'USDJPY']
    correlation_dict = {}
                ...
                if operar:
                    ...
                    if (bid in final_liquidity or ask in final_liquidity) or not comprobacion_inicial:
                        ...
                        if not (type(anterior_data_5m) != None and len(data_5m) == anterior_data_5m):
                            ...
                            args = {"correlation_dict": correlation_dict, "recalcular": False, "all_data": all_data, "all_data_1m": all_data_1m, "all_data_2m": all_data_2m, "all_data_15m": all_data_15m, "all_data_5m": all_data_5m, "all_data_1h": all_data_1h, "name": name, "mode": "real"}
...
if __name__=="__main__":
    run(
        dinero_inicial = 6000, name = "EURUSD", tamanyo_break_even = 16, break_even_size = -15, enable_break_even = False,
